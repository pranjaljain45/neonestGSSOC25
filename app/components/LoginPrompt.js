        ...
        <div className="login-prompt-card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm hover:text-gray-700 transition-colors duration-300">
              {t("loginPrompt.description", { section: sectionName })}
            </p>
          </div>
          ...
          <div className="space-y-3">
            <Button
              ...
              className={`w-full py-3 rounded-xl font-semibold shadow-md transition-all duration-300 transform ${isNavigating
            ...
            >
              {isNavigating ? (
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span>{t("loginPrompt.loading")}</span>
                </div>
              ) : (
